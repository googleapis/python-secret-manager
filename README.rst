Python Client for Cloud Secret Manager API
==========================================

|stable| |pypi| |versions|

`Cloud Secret Manager API`_: 
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-secret-manager.svg
   :target: https://pypi.org/project/google-cloud-secret-manager/
.. _Cloud Secret Manager API: https://cloud.google.com/secret-manager/
...
3. `Enable the Cloud Secret Manager API.`_
4. `Setup Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Cloud Secret Manager API.:  https://cloud.google.com/secret-manager/
...
-  Read the `Client Library Documentation`_ for Cloud Secret Manager API
   to see other available methods on the client.
-  Read the `Cloud Secret Manager API Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Cloud Secret Manager API Product documentation:  https://cloud.google.com/secret-manager/

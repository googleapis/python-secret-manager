...
_LISTSECRETSRESPONSE.fields_by_name['secrets'].message_type = google_dot_cloud_dot_secretmanager__v1_dot_proto_dot_resources__pb2._SECRET
_CREATESECRETREQUEST.fields_by_name['secret'].message_type = google_dot_cloud_dot_secretmanager__v1_dot_proto_dot_resources__pb2._SECRET
_ADDSECRETVERSIONREQUEST.fields_by_name['payload'].message_type = google_dot_cloud_dot_secretmanager__v1_dot_proto_dot_resources__pb2._SECRETPAYLOAD
_LISTSECRETVERSIONSRESPONSE.fields_by_name['versions'].message_type = google_dot_cloud_dot_secretmanager__v1_dot_proto_dot_resources__pb2._SECRETVERSION
_UPDATESECRETREQUEST.fields_by_name['secret'].message_type = google_dot_cloud_dot_secretmanager__v1_dot_proto_dot_resources__pb2._SECRET
_UPDATESECRETREQUEST.fields_by_name['update_mask'].message_type = google_dot_protobuf_dot_field__mask__pb2._FIELDMASK
_ACCESSSECRETVERSIONRESPONSE.fields_by_name['payload'].message_type = google_dot_cloud_dot_secretmanager__v1_dot_proto_dot_resources__pb2._SECRETPAYLOAD
